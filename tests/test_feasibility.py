...
def test_process_tree():
    ...
    from openwukong.uia.process_tree import ProcessTree
...
def test_element_finder():
    ...
    from openwukong.uia.process_tree import ProcessTree
    from openwukong.uia.element_finder import ElementFinder
...
def test_agent_bridge():
    ...
    from openwukong.bridge.agent_bridge import AgentBridge
